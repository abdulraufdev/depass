...
class _EncryptionScreenState extends State<EncryptionScreen> {
    ...
    showCupertinoModalPopup(
      ...
      builder: (BuildContext context) {
        return CupertinoActionSheet(
          title: const Text('Select AES Mode'),
          actions: DepassAESMode.values.map((mode) {
            return CupertinoActionSheetAction(
              ...
              child: Text(_encryptionService.getModeDescription(mode)),
            );
          }).toList(),
  ...
  void _showKeyLengthPicker(BuildContext context) {
    showCupertinoModalPopup(
      ...
      builder: (BuildContext context) {
        return CupertinoActionSheet(
          title: const Text('Select Key Length'),
          actions: AESKeyLength.values.map((length) {
            return CupertinoActionSheetAction(
              ...
              child: Text(_encryptionService.getKeyLengthDescription(length)),
            );
          }).toList(),
          cancelButton: CupertinoActionSheetAction(
            onPressed: () => Navigator.pop(context),
